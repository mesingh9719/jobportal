...
{{ View::make('seeker/templates/navbar') }}
                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="dashboard-menu">
                            <ul>
                                ...
                                <li><i class="fas fa-file-alt"></i><a href="/users/resume">Resume</a></li>
                                <li><i class="fas fa-heart"></i><a href="dashboard-bookmark.html">Bookmarked</a></li>
                                <li><i class="fas fa-check-square"></i><a href="dashboard-applied.html">Applied Job</a>
                                </li>
...
{{ View::make('seeker/templates/footer') }}
</body>
</html>
